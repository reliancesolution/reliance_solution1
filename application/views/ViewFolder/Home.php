...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/elastic_grid.css"> 
    <!-- Circle counter cdn css file -->
    <link rel='stylesheet prefetch' href='https://cdn.rawgit.com/pguso/jquery-plugin-circliful/master/css/jquery.circliful.css'>    
    <!-- Default Theme css file -->
    <link id="orginal" href="<?php echo base_url(); ?>assets/css/themes/default-theme.css" rel="stylesheet">
      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> 
          ...
          <div class="navbar-header">
            ...
            <!-- TEXT BASED LOGO -->
            <a class="navbar-brand" href="#">Re<span>liance</span></a>
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right main_nav">
              <li class="active"><a href="#slides">Home</a></li>
...
<!--              <img src="<?php echo base_url(); ?>assets/img/full-slider/full-slide7.jpg" alt="img">-->
              <!-- FIRST SLIDE CAPTION-->
              <div class="slider_caption">
                <h2>Hi,We are Reliance Solution</h2>
                <p>we are a group of experienced designers and developers</p>
                <a href="#team" class="slider_btn">Who We are</a>              
              </div>
            </li>
            ...
            <li>
              ...
              <!--<img src="<?php echo base_url(); ?>assets/img/full-slider/full-slide2.jpg" alt="img">-->
              <!-- SECOND SLIDE CAPTION-->
              <div class="slider_caption">
                <h2>Hi,We are Reliance</h2>
                <p>we are a group of experienced designers and developers</p>
            ...
            <li>
              ...
              <!--<img src="<?php echo base_url(); ?>assets/img/full-slider/full-slide1.jpg" alt="img">-->
              <!-- THIRD SLIDE CAPTION-->
              <div class="slider_caption">
          ...
          <div class="col-lg-12 col-md-12">
            <div class="about_area">
              ...
              <div class="heading">
                ...
                <p>
                    We are a freelance group of trusted Software Engineers, Network Engineer, and Web Designers who provide solution to small and medium sized businesses using Website and Desktop application. Our members are great achievers who hold certifications such as Cisco and Microsoft and IELTS(International English Language Testing System). We are not only promoting the skills of our members but also the trust and confidence given to us by our Clients.
                </p>
              </div>
                      ...
                      <div class="panel-group" id="accordion">
                        ...
                        <div class="panel panel-default wow fadeInLeft">
                          ...
                          <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                To make information understandable, it has to be readable,easy to access and it should be user friendly so that the user will understand what the Solution is all about.
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="panel panel-default wow fadeInLeft">
                          ...
                          <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                            To deliver the 100% accessability of the Website,it has a feature that can be accessed on different devices such as Smartphone, Tablet, and Computer Desktop.
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="panel panel-default wow fadeInLeft">
                          ...
                          <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                              To deliver the message and what the website is all about, the details should be specific and easy to understand.
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="about_slider">
                      ...
                      <div class="featured_slider">
                        ...
                        <div class="single_iteam">
                          <a href="#"> <img src="<?php echo base_url(); ?>assets/img/feature_img1.jpg" alt="img"></a>                          
                        </div>
                         SINGLE SLIDE IN THE SLIDER 
                        <div class="single_iteam">
                          <a href="#"> <img src="<?php echo base_url(); ?>assets/img/feature_img2.jpg" alt="img"></a>                          
                        </div>
                         SINGLE SLIDE IN THE SLIDER 
                        <div class="single_iteam">
                          <a href="#"> <img src="<?php echo base_url(); ?>assets/img/feature_img3.jpg" alt="img"></a>                           
                        </div>
                         SINGLE SLIDE IN THE SLIDER 
                        <div class="single_iteam">
                          <a href="#"> <img src="<?php echo base_url(); ?>assets/img/feature_img6.jpg" alt="img"></a>                           
                        </div>
                         SINGLE SLIDE IN THE SLIDER 
                        <div class="single_iteam">
                          <a href="#"> <img src="<?php echo base_url(); ?>assets/img/feature_img5.jpg" alt="img"></a>                           
                        </div>
                      </div>-->
                      <!-- END FEATURED SLIDER -->
                    </div>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3">
                   <div class="single_skill wow fadeInUp">
                     <div id="myStat" data-dimension="150" data-text="85%" data-info="" data-width="10" data-fontsize="25" data-percent="85" data-fgcolor="#999" data-bgcolor="#fff"  data-icon="fa-task"></div>
                      <h4>Web Development and Design(HTML/CSS/SQL/JS)</h4>                      
                    </div>
                  </div>
                  <!-- START SINGLE SKILL-->
                  <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="single_skill wow fadeInUp">
                      <div id="myStathalf2" data-dimension="150" data-text="80%" data-info="" data-width="10" data-fontsize="25" data-percent="80" data-fgcolor="#999" data-bgcolor="#fff"  data-icon="fa-task"></div>
                      <h4>Cisco Network Design and Management(Network Fundamentals,Routing Protocols, and Concepts LAN Switching, and Wireless Accessing the Wan)</h4>
                    </div>
                  </div>
                  <!-- START SINGLE SKILL-->
                  <div class="col-lg-3 col-md-3 col-sm-3">                 
                    <div class="single_skill wow fadeInUp">
                      <div id="myStat2" data-dimension="150" data-text="85%" data-info="" data-width="10" data-fontsize="25" data-percent="85" data-fgcolor="#999" data-bgcolor="#fff"  data-icon="fa-task"></div>
                      <h4>Software and Desktop Application (C#,VB.NET,WPF,SQL,JAVA)</h4>
                    </div>
                  </div>
                  <!-- START SINGLE SKILL-->
                  <div class="col-lg-3 col-md-3 col-sm-3">                 
                    <div class="single_skill wow fadeInUp">
                      <div id="myStat3" data-dimension="150" data-text="90%" data-info="" data-width="10" data-fontsize="25" data-percent="90" data-fgcolor="#999" data-bgcolor="#fff"  data-icon="fa-task"></div>
                      <h4>Customer Service and Social Media Marketing</h4>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            ...
            <div class="heading">
              ...
              <p>We are glad to deliver you the services that we have</p>
            </div>
          </div>          
        </div>
        <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                  ...
                  <div class="single_service wow fadeInRight">
                    <div class="service_iconarea">
                      <span class="fa fa-share-alt service_icon"></span>
                    </div>
                    <h3 class="service_title">Network Design and Routing</h3>
                    <!--<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text</p>-->
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                  ...
                  <div class="single_service wow fadeInLeft">
                    ...
                    <h3 class="service_title">Web Design & Development</h3>
                    <!--<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text</p>-->
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="team_slider">  
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="<?php echo base_url(); ?>assets/img/danico.png" alt="img">
                    </div>
                    <h5 class="">Danico Balane</h5>
                    <span>Team Leader</span>                        
                    <p>B.S Computer Engineering, Certified Microsoft Professional,Microsoft Certified Technology Specialist, and IT leader.</p>
                    <div class="team_social">
                      <a href="https://www.facebook.com/nico.simple"><i class="fa fa-facebook"></i></a>
                      <a href="https://www.facebook.com/nico.simple"><i class="fa fa-facebook"></i></a>
<!--                      <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="<?php echo base_url(); ?>assets/img/anna.jpg" alt="img">
                    </div>
                    <h5>Anna Bonalba</h5>
                    <span>Customer Service Manager</span>                        
                    <p>Customer service and social media marketing, International English Language Testing System Passer</p>
                    <div class="team_social">
                      <a href="https://www.facebook.com/AnnaTheresaBonalba"><i class="fa fa-facebook"></i></a>
<!--                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                      <a href="#"><i class="fa fa-linkedin"></i></a>-->
                    </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="<?php echo base_url(); ?>assets/img/samones.jpg" alt="img">
                    </div>
                    <h5>Rafael Samones</h5>
                    <span>Network Engineer</span>                        
                    <p>BS. Computer Engineering, Certified Microsoft Professional,Microsoft Certified Technology Specialist,Hardware and Network Specialist.</p>
                    <div class="team_social">
                      <a href="https://www.facebook.com/materzam"><i class="fa fa-facebook"></i></a>
<!--                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                      <a href="#"><i class="fa fa-linkedin"></i></a>-->
                    </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="<?php echo base_url(); ?>assets/img/chris.jpg" alt="img">
                    </div>
                    <h5>Chris Tongol</h5>
                    <span>Hardware and Network Specialist</span>                        
                    <p>BS. Computer Engineer and Information Technology.  Embedded and Network Design Specialist</p>
                    <div class="team_social">
                      <a href="https://www.facebook.com/chrisgerald.tongol"><i class="fa fa-facebook"></i></a>
<!--                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                      <a href="#"><i class="fa fa-linkedin"></i></a>-->
                    </div>
...
<!--                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="<?php echo base_url(); ?>assets/img/team-5.jpg" alt="img">
                    </div>
                    <h5>Jamie Sidens</h5>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="<?php echo base_url(); ?>assets/img/team-1.jpg" alt="img">
                    </div>
                    <h5>Jamie Sidens</h5>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="<?php echo base_url(); ?>assets/img/team-2.jpg" alt="img">
                    </div>
                    <h5>Jone Doe</h5>
              ...
              <div class="blog_slider">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="single_post wow fadeInUp">
                    <div class="blog_img">
                      <img src="<?php echo base_url(); ?>assets/img/blog_img1.jpg" alt="img">
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="single_post wow fadeInUp">
                    <div class="blog_img">
                      <img src="<?php echo base_url(); ?>assets/img/blog_img2.jpg" alt="img">
                    </div>
                    <h3>Sed ut perspiciatis unde omnis</h3>
                    <div class="post_commentbox">
                      <a href="#"><i class="fa fa-user"></i>Wpfreeware</a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="single_post wow fadeInUp">
                    <div class="blog_img">
                      <img src="<?php echo base_url(); ?>assets/img/blog_img3.jpg" alt="img">
                    </div>
                    <h3>Sed ut perspiciatis unde omnis</h3>
                    <div class="post_commentbox">
                      <a href="#"><i class="fa fa-user"></i>Wpfreeware</a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="single_post wow fadeInUp">
                    <div class="blog_img">
                      <img src="<?php echo base_url(); ?>assets/img/blog_img4.jpg" alt="img">
                    </div>
                    <h3>Sed ut perspiciatis unde omnis</h3>
                    <div class="post_commentbox">
                      <a href="#"><i class="fa fa-user"></i>Wpfreeware</a>
            ...
            <div class="testimonial_customer">
              ...
              <ul class="testimonial_slider">
                ...
                <li>
                  <div class="media testi_media">
                    <a class="media-left testi_img" href="#">
                      <img src="<?php echo base_url(); ?>assets/img/team-4.jpg" alt="img">
                    </a>
                    <div class="media-body">
                ...
                <div class="clients_slider">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="single_client">
                      <img src="<?php echo base_url(); ?>assets/img/clients_img1.png" alt="clients Brand">
                    </div>
                  </div>
                   BEGAIN SINGLE CLIENT SLIDE#2 
                  <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="single_client">
                      <img src="<?php echo base_url(); ?>assets/img/clients_img2.png" alt="clients Brand">
                    </div>
                  </div>
                   BEGAIN SINGLE CLIENT SLIDE#3 
                  <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="single_client">
                      <img src="<?php echo base_url(); ?>assets/img/clients_img4.png" alt="clients Brand">
                    </div>
                  </div>
                   BEGAIN SINGLE CLIENT SLIDE#4 
                  <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="single_client">
                      <img src="<?php echo base_url(); ?>assets/img/clients_img3.png" alt="clients Brand">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="single_client">
                      <img src="<?php echo base_url(); ?>assets/img/clients_img5.png" alt="clients Brand">
                    </div>
                  </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="heading">
              ...
              <p>We'll free up our time to hear about your brilliant ideas then we will start working on them and we will make them happen.</p>
            </div>
          </div>
        </div>       
        <div class="row">
...
<!--              <div class="contact_form">
                ...
                <p><span class="glyphicon glyphicon-phone"></span> Contact Number: +63915-829-3432</p>
                <p><span class="glyphicon glyphicon-envelope"></span> reliancesolution2014@gmail.com</p>
                <h3>Meet up Locations</h3>
                <p><span class="glyphicon glyphicon-map-marker"></span> SM North Starbucks</p>
                <p><span class="glyphicon glyphicon-map-marker"></span> SM Megamall Starbucks</p>
                <p><span class="glyphicon glyphicon-map-marker"></span> SM Manila Starbucks</p>
                <p><span class="glyphicon glyphicon-map-marker"></span> Glorietta Starbucks</p>
            </div>
            <!-- BEGAIN CONTACT MAP -->
          ...
          <div class="container">               
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
              <div class="single_contact_feaured wow fadeInUp">
                ...
                <h4>Email Address</h4>
                <p>reliancesolution2014@gmail.com</p>
              </div>
            </div>
            <!-- BEGAIN CALL US FEATURE -->
            <div class="col-lg-3 col-md-3 col-sm-6">
...
<!--    <section id="subscribe">
         ...
         <div class="row">
           <div class="col-lg-6 col-md-6 col-sm-6">
             <div class="footer_left">
               ...
               <p>Designed By <a href="http://www.wpfreeware.com">WFw</a>.</p>
			   <!--=========== Designed By WpFreeware Team ================-->
             </div>
           </div>
           <div class="col-lg-6 col-md-6 col-sm-6">
             <div class="footer_right">
               <ul class="social_nav">
                 <li><a href="https://www.facebook.com/reliancesolution2014/"><i class="fa fa-facebook"></i></a></li>
    ...
    <!-- superslides slider -->
    <script src="<?php echo base_url(); ?>assets/js/jquery.superslides.min.js" type="text/javascript"></script>
    <!-- slick slider -->
    ...
    <script src="<?php echo base_url(); ?>assets/js/elastic_grid.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/portfolio_slider.js"></script>
