...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>KoreabooSolution : Blog Archive</title>
            ...
            <div class="blogarchive_content">        
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="single_post wow fadeInUp">
                    <div class="blog_img">
                      <img src="<?php echo base_url(); ?>assets/img/news.jpg" alt="img">
                    </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="blog_sidebar">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <a class="news_img" href="#">
                          <img class="media-object" src="<?php echo base_url(); ?>assets/img/news.jpg" alt="img">
                        </a>
                      </div>
                      <div class="media-body">
                       <a href="blog-single.html">Dummy text of the printing and typesetting industry</a>
                    ...
                    <li class="cat-item">
                      <a href="#">Business</a>
                        <ul>
                          ...
                          <li><a href="#">Photography 2</a></li>
                          <li><a href="#">Photography 3</a></li>
                        </ul>
                    </li>
                    <li class="cat-item"><a href="#">Entertainment</a></li>
                    <li class="cat-item"><a href="#">Fashion</a></li>
                    <li class="cat-item"><a href="#">Bloging</a></li>
                  </ul>
              </div>
              <!-- End single sidebar -->
              <!-- Start single sidebar -->
              <div class="single_blogsidebar">
                <h2>Tags</h2>
                <div class="tagcloud">
                  <a href="#"><i class="fa fa-tags"></i>Fashion</a>
                  <a href="#"><i class="fa fa-tags"></i>News</a>
